                     ...
                     std::vector<LidarPoint> &lidarPointsCurr, double frameRate, double &TTC)
{
    ...
    int prevMedianIdx = floor(xPrev.size()) / 2;
    int currMedianIdx = floor(xCurr.size()) / 2;
    
    double xPrevMedian = prevMedianIdx % 2 == 0 ? (xPrev[prevMedianIdx] + xPrev[prevMedianIdx - 1]) /2 : xPrev[prevMedianIdx];
    double xCurrMedian = currMedianIdx % 2 == 0 ? (xCurr[currMedianIdx] + xCurr[currMedianIdx - 1]) /2 : xCurr[currMedianIdx];
